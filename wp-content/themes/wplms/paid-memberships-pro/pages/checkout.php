...
?>
<div id="pmpro_level-<?php echo esc_attr($pmpro_level->id); ?>" class="<?php echo esc_attr($pmpro_checkout_gateway_class); ?>">
			...
			<div class="pmpro_checkout-fields">
				...
				<?php if($pmpro_show_discount_code) { ?>
					...
					<?php } elseif($pmpro_review && $discount_code) { ?>
						<p><strong><?php _e('Discount Code', 'paid-memberships-pro' );?>:</strong> <?php echo esc_html($discount_code) ?></p>
					<?php } ?>
				<?php } ?>
						...
						<div class="pmpro_checkout-field pmpro_payment-card-type">
							...
							<select id="CardType" name="CardType" class=" <?php echo pmpro_getClassForField("CardType");?>">
								<?php foreach($pmpro_accepted_credit_cards as $cc) { ?>
									<option value="<?php echo esc_attr($cc); ?>" <?php if($CardType == $cc) { ?>selected="selected"<?php } ?>><?php echo esc_attr($cc); ?></option>
								<?php } ?>
							</select>
						</div>
					<?php } else { ?>
				...
				<div class="pmpro_checkout-field pmpro_payment-expiration">
					...
					<select id="ExpirationMonth" name="ExpirationMonth" class=" <?php echo pmpro_getClassForField("ExpirationMonth");?>">
						...
						<?php
							...
							{
						?>
							<option value="<?php echo esc_attr($i)?>" <?php if($ExpirationYear == $i) { ?>selected="selected"<?php } ?>><?php echo esc_attr($i); ?></option>
						<?php
							}
						?>
					</select>
...
<?php echo wpautop(do_shortcode($tospage->post_content));?>
	...
	<div class="pmpro_submit">
		<hr />
		<?php if ( $pmpro_msg ) { ?>
			<div id="pmpro_message_bottom" class="pmpro_message <?php echo $pmpro_msgt; ?>"><?php echo esc_html($pmpro_msg); ?></div>
		<?php } else { ?>
