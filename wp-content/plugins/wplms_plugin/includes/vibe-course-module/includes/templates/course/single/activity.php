...
<div class="item-list-tabs activity-type-tabs no-ajax" id="subnav" role="navigation">
	<ul>
		...
		if($flag){ ?>
		<li id="activity-course_<?php echo $bp->current_item; ?>" class="selected"><a href="#" title=""><?php _e('All Activity','wplms'); ?></a></li>
		<?php } ?>
		<?php
		if(is_user_logged_in() && bp_course_is_member()){ ?>
		<li id="activity-course_personal_<?php echo $bp->current_item; ?>"><a href="#" title=""><?php _e('My Activity','wplms'); ?></a></li>
		<?php } ?>
