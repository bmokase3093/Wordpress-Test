...
?>
<h2 class="heading">
	<span><?php  _e('Course Curriculum','wplms'); ?></span>
</h2>
...
if(!empty($course_curriculum)){
	...
	?>
	<div class="message"><?php echo _x('No curriculum found !','Error message for no curriculum found in course curriculum ','wplms'); ?></div>
	<?php	
}
?>
</div>
