...
<div class="students_undertaking">
	...
	echo '<strong>'.$students.__(' STUDENTS ENROLLED','wplms').'</strong>';
...
<div class="course_description">
	...
	<?php 
		if($more_flag){
			echo '<a href="#" id="more_desc" class="link" data-middle="'.$middle.'">'.__('READ MORE','wplms').'</a>';
		}
	?>
	</div>
	<?php 
	...
	?>
		...
		?>
		<?php 
			echo '<a href="#" id="less_desc" class="link">'.__('LESS','wplms').'</a>';
		?>
		</div>
	<?php
		}
