...
class WPLMS_Course_Component_Init{
    ...
    private function __construct(){
        ...
        //add_action('wp_head',array($this,'check_elementor'));
    }
    ...
    static function get_wplms_course_data(){
        ...
        $wplms_course_data = array(
            ...
            'hide_complete_course'=>(!empty($tips->lms_settings['general']['hide_complete_course_button_curriculum'])?true:false),
            'wplms_course_delete'=>(!empty($tips->lms_settings['general']['wplms_course_delete'])?true:false),
            ...
            'start_popup'=>false,
            'default_manage_courses_orderby'=>empty($tips->lms_settings['general']['default_manage_courses_orderby'])?null:$tips->lms_settings['general']['default_manage_courses_orderby'],
            'default_manage_courses_order'=>empty($tips->lms_settings['general']['default_manage_courses_order'])?null:$tips->lms_settings['general']['default_manage_courses_order'],
            'submit_popup'=>false,
            ...
            'courses_per_page' => apply_filters('wplms_default_courses_per_page',12),
            'per_page' => apply_filters('wplms_default_item_per_page',20),
            'time_labels' => array(
            ...
            'translations'=>array(
                'delete_curriculum'=>_x('Delete all curriculum including quizzes/units/assignments as well?','','wplms'),
                'mark_resolved'=>_x('Mark Resolved','','wplms'),
                'no_feedbacks'=>_x('There are no feedbacks found for this question!','','wplms'),
                'please_add_title' => _x('Please add title','','wplms'),
                'ends_in' => _x('Ends In','','wplms'),
                'starts_in' => _x('Starts In','','wplms'),
                'enter_your_reply'=>_X('Enter your reply','','wplms'),
                'required'=>_x('*','','wplms'),
                ...
                'start_assignment'=>_x('Start Assignment','','wplms'),
                ...
                'submit_feedback'=>_x('Submit Feedback','','wplms'),
                'add_feedback_to_flag'=> _x('Add some feedback to flag','','wplms'),
                ...
                'notes'=>_x('Notes','refresher','wplms'),
                'comments'=>_x('Comments','refresher','wplms'),
                'search_unit' =>_x('Search Units','','wplms'),
                'add_note'=>_x('Add note','','wplms'),
                'edit_note'=>_x('Edit note','','wplms')
            ),
        );
