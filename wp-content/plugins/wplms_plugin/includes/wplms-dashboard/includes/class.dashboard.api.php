...
class WPLMS_Dashboard_Api
{
        ...
        switch($type){
            ...
            case 'new': 
                        ...
                        {   
                            ...
                            do_action('wplms_course_unit_comment',$unit_id,$user_id,$comment_data,$args);  
                        ...
                        if (!empty($total_commission_cur)  ) {
                            foreach (
                                ...
                                $multi_html .=
                                    ...
                                    $key .
                                    '" class="tab-pane" ' .
                                    ((!empty($currencies_data) && is_array($currencies_data) && count($currencies_data) < 2)
                                        ? 'style="display:block"'
                                        : '') .
                                    '>';
    ...
    function new_instructor_announcement($request)
    {
        ...
        if(!empty($student_type)){
            if($student_type=='students_pursuing'){
                $type=2;
            }
            if($student_type=='students_finished'){
                $type=3;
            }
        }
        do_action(
