...
function thumbnail_generator($custom_post,$featured_style,$cols='medium',$n=100,$link=0,$zoom=0){
    ...
    switch($featured_style){
            ...
            case 'course':
                    ...
                    $return .=apply_filters('wplms_course_thumb_extras','',$custom_post); // Use this filter to add Extra HTML to the course featured block
                    $return .='</div>';
                    $return .='</div>';
           ...
           case 'course2':
            ...
            case 'course3':
                    ...
                    $return .= '</div></div>';
                    $return .=apply_filters('wplms_course_thumb_extras','',$custom_post);
                    $return .= '</div></div>';
