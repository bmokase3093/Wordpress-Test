...
class VibeBP_Register{
    ...
    function check_flatpickr_script_lang(){
        ...
        if( ((!empty($wp_scripts->queue) && in_array('vibebp-flatpickr',$wp_scripts->queue)) || !empty($wp_scripts->done) && in_array('vibebp-flatpickr',$wp_scripts->done))  && vibebp_get_flatpickrLang() && vibebp_get_flatpickrLang()!='en'){
            ...
            echo '<script src="https://npmcdn.com/flatpickr/dist/l10n/'.vibebp_get_flatpickrLang().'.js"></script>';
            ?>
            <script>
    ...
    function get_vibebp(){
        ...
        add_action('wp_footer',[$this,'tour_wrapper'],999);
        $group_types = [];
        ...
        $vibebp= array(
            ...
            'settings'=>array(
                'forgotpassword_link' => (!empty(vibebp_get_setting('wp_forgot_password'))?wp_lostpassword_url():''),
                'giphy'=>array(
                    'api_key'=>vibebp_get_setting('giphy_api_key'),
                    'endpoints'=>array(
                ...
                'member_types_registration'=>(!empty(vibebp_get_setting('member_types_registration'))?true:false),
                'registration_invite_codes'=>(!empty(vibebp_get_setting('registration_invite_codes'))?true:false),
                'enable_reactions'=>(!empty(vibebp_get_setting('enable_reactions'))?true:false),
                'reactions'=>vibebp_get_reactions_array(),
                'post_data_check_interval'=>apply_filters('vibebp_show_join_button',1*60*60*1000),
                ...
                'ipstack_access_id'=>vibebp_get_setting('ipstack_access_id'),
                'timestamp'=>time(),
                ...
                'strong_password' => vibebp_get_setting('strong_password'),
                ...
                'auth'=>array(
                    ...
                    'microsoft'=>vibebp_get_setting('firebase_microsoft_auth')
                ),
                'is_rtl' => is_rtl(),
            ...
            'translations'=>array(
                ...
                'forgot_password'=> stripslashes(vibebp_get_setting('forgot_password')),
                ...
                'announcements'=>__('Announcemets', 'vibebp'),
                'no_announcements'=>__('No Announcemets available!', 'vibebp'),
...
','vicon vicon-wand','vicon vicon-save','vicon vicon-save-alt','vicon vicon-direction','vicon vicon-direction-alt','vicon vicon-user','vicon vicon-link','vicon vicon-unlink','vicon vicon-trash','vicon vicon-target','vicon vicon-tag','vicon vicon-desktop','vicon vicon-tablet','vicon vicon-mobile','vicon vicon-email','vicon vicon-star','vicon vicon-spray','vicon vicon-signal','vicon vicon-shopping-cart','vicon vicon-shopping-cart-full','vicon vicon-settings','vicon vicon-search','vicon vicon-zoom-in','vicon vicon-zoom-out','vicon vicon-cut','vicon vicon-ruler','vicon vicon-ruler-alt-2','vicon vicon-ruler-pencil','vicon vicon-ruler-alt','vicon vicon-bookmark','vicon vicon-bookmark-alt','vicon vicon-reload','vicon vicon-plus','vicon vicon-minus','vicon vicon-close','vicon vicon-pin','vicon vicon-pencil','vicon vicon-pencil-alt','vicon vicon-paint-roller','vicon vicon-paint-bucket','vicon vicon-na','vicon vicon-medall','vicon vicon-medall-alt','vicon vicon-marker','vicon vicon-marker-alt','vicon vicon-lock','vicon vicon-unlock','vicon vic
svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <path fill="#000" fill-rule="nonzero" d="M11.917 6.61l7.916-4.57v19.92l-7.916-4.57L4 21.96V2.04l7.917 4.57zM8.154 12l3.938 2.277L16.029 12l-3.937-2.277L8.154 12zM6.747 6.415v3.259l2.816-1.63-2.816-1.629zm0 7.911v3.014l2.605-1.507-2.605-1.507zm10.501 3.014v-3.014l-2.605 1.507 2.605 1.507zm-2.816-9.296l2.816 1.63V6.415l-2.816 1.63z"/>
        ...
        if((function_exists('bp_is_user') && bp_is_user()) || (!empty($post) &&  !empty($post->post_content) && has_shortcode($post->post_content,'vibebp_profile'))){
            ...
            $vibebp['components']['members_detail']=array(
                ...
                'settings' => array(
                    'bulk_actions' => array(
                        ['key'=>'add_tag','label'=>__('Add Tag','vibebp')],
                        ['key'=>'remove_tag','label'=>__('Remove Tag','vibebp')],
                        ['key'=>'send_message','label'=>__('Send Message','vibebp')],
                        ['key'=>'add_member_type','label'=>__('Add Member Type','vibebp')],
                        ['key'=>'remove_member_type','label'=>__('Remove Member Type','vibebp')],
                    )
                ) 
            );
    ...
    function enqueue_head(){
        ...
        if(vibebp_get_setting('google_captcha_public_key')){
        ...
        if(function_exists('WC')){
            ...
            wp_localize_script('vibebp-cart','vibebp_cart',[
                ...
                'settings'=>[
                    ...
                    'is_wallet_active'=>vibebp_get_setting('enable_wallet','wallet'),
    ...
    background: '.(function_exists('vibe_get_customizer')?vibe_get_customizer('header_bg'):'').' url('.(function_exists('vibe_get_option')?vibe_get_option('logo'):(has_custom_logo()?esc_url( wp_get_attachment_url( get_theme_mod( 'custom_logo' ) ) ):'')).');background-repeat: no-repeat;background-position: center;}');
        ...
        if(apply_filters('vibebp_enqueue_profile_script',$enqueue_script)){
            ...
            if(vibebp_get_flatpickrLang() && vibebp_get_flatpickrLang()!='en'){
                 wp_enqueue_script('flatpickrLang','https://npmcdn.com/flatpickr/dist/l10n/'.vibebp_get_flatpickrLang().'.js',array(),VIBEBP_VERSION,true);
            ...
            if(!empty(vibebp_get_setting('mask_videos'))){
           ...
           wp_enqueue_script('plyr');
            ...
            if(!empty(vibebp_get_setting('editor_interface')) && vibebp_get_setting('editor_interface') == 'full'){
            ...
            ob_start();
                ...
                if(vibebp_get_setting('editor_interface') && vibebp_get_setting('editor_interface') != 'basic'){ ?>
            (function () {
            ...
            array(
                ...
                'mathjax'=>plugins_url('../assets/js/MathJax2.7.js',__FILE__),
                'media_order'=>array(
            ...
            if(!empty(vibebp_get_setting('editor_interface'))){
                if(vibebp_get_setting('editor_interface') == 'advanced'){
                    $editor_script_Args['blocks']['math']=0;
                }
                if(vibebp_get_setting('editor_interface') == 'basic'){
            ...
            if(!empty(vibebp_get_setting('microlearning_elements'))){
    ...
    function tour_wrapper(){
        if(did_action('footer')){
            echo '<div id="tour_wrapper"></div>';
        }
    }
